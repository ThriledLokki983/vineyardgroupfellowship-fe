    ...
    <Layout variant="default">
      <div className={styles.legalPage}>
        <div className={styles.header}>
          <h1 className={styles.title}>Community Terms of Use</h1>
        ...
        <div className={styles.content}>
          ...
          <section className={styles.section}>
            ...
            <ul>
              <li>Use the platform solely for personal recovery support and community fellowship</li>
              <li>Respect the privacy and anonymity of all community members</li>
              <li>Not reproduce, distribute, or commercially exploit any platform content</li>
              <li>Not attempt to reverse engineer, modify, or compromise platform security</li>
              <li>Not remove or alter any proprietary notices or attribution</li>
            </ul>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul>
              ...
              <li>Honor different recovery paths, backgrounds, and belief systems</li>
              <li>Use language that builds up rather than tears down</li>
              <li>Respect boundaries around sharing personal information</li>
            </ul>

            <h3>Privacy & Anonymity</h3>
            <ul>
              <li>Respect the anonymity choices of all community members</li>
              <li>Never share another member's story or information outside the platform</li>
              <li>Use discretion when sharing your own recovery details</li>
              <li>Report any privacy violations to our moderation team</li>
            </ul>

            <h3>Supportive Fellowship</h3>
            <ul>
              <li>Offer encouragement and hope to those who are struggling</li>
              <li>Share experience, strength, and hope rather than advice</li>
              <li>Listen actively and respond with empathy</li>
              <li>Celebrate milestones and progress, no matter how small</li>
            </ul>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul>
              ...
              <li>Keeping your contact information current for community and safety purposes</li>
            </ul>
          ...
          <section className={styles.section}>
            ...
            <p>
              To maintain a safe and supportive fellowship environment, the following behaviors are strictly prohibited:
            </p>

            <h3>Harmful or Disruptive Behavior</h3>
            <ul>
              <li>Harassment, bullying, or intimidation of any community member</li>
              <li>Sharing content that promotes self-harm, substance abuse, or dangerous behaviors</li>
              <li>Discrimination based on race, gender, religion, sexual orientation, or recovery status</li>
              <li>Trolling, inflammatory posts, or deliberately disruptive behavior</li>
            </ul>

            <h3>Privacy & Safety Violations</h3>
            <ul>
              <li>Sharing personal information of other members without consent</li>
              <li>Attempting to contact members outside the platform without permission</li>
              <li>Recording, screenshotting, or documenting private fellowship communications</li>
              <li>Creating fake accounts or impersonating other members</li>
            </ul>

            <h3>Commercial & Inappropriate Content</h3>
            <ul>
              <li>Promoting products, services, or treatment programs for financial gain</li>
              <li>Posting advertising, spam, or promotional content</li>
              <li>Sharing illegal content or encouraging illegal activities</li>
              <li>Posting sexually explicit, violent, or otherwise inappropriate material</li>
            </ul>

            <h3>Platform Misuse</h3>
            <ul>
              <li>Attempting to hack, compromise, or disrupt platform security</li>
              <li>Using automated tools or bots to interact with the community</li>
              <li>Violating any applicable local, state, or federal laws</li>
              <li>Interfering with other members' use of fellowship services</li>
            </ul>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul>
              ...
              <li>Educational content, recovery resources, and program materials</li>
              <li>Vineyard Group Fellowship trademarks, logos, and branding</li>
          ...
          <section className={styles.section}>
            ...
            <ol>
              <li><strong>Community education:</strong> Gentle reminder about fellowship principles</li>
              <li><strong>Temporary restriction:</strong> Limited access to specific features</li>
              <li><strong>Account suspension:</strong> Temporary removal from community (with appeal process)</li>
              <li><strong>Permanent removal:</strong> Only for severe violations that threaten member safety</li>
            </ol>
          ...
          <section className={styles.section}>
            ...
            <ul>
              <li>Scheduled maintenance and security updates</li>
              <li>Technical issues or server maintenance</li>
              <li>Emergency situations requiring immediate platform changes</li>
          ...
          <section className={styles.section}>
            ...
            <ul>
              <li>Individual recovery outcomes or treatment decisions</li>
              <li>Content or advice shared by community members</li>
              <li>Technical issues that may affect platform access</li>
              <li>Interactions between members outside our platform</li>
          ...
          <section className={styles.section}>
            ...
            <ul>
              ...
              <li>Content moderation follows US legal and cultural standards</li>
              <li>Local laws regarding recovery, mental health, or online communities may apply</li>
              <li>Crisis resources and emergency contacts are primarily US-focused</li>
            </ul>
          </section>
          ...
          <section className={styles.section}>
            ...
            <ul>
              <li>Email notifications to all active members</li>
          ...
          <section className={styles.section}>
            ...
            <p>
              Our Fellowship Support Team is here to help with questions, concerns, or assistance:
            </p>
            <ul>
              <li><strong>Community Support:</strong> <a href="mailto:support@vineyardgroupfellowship.org" className={styles.link}>support@vineyardgroupfellowship.org</a></li>
              <li><strong>Legal Questions:</strong> <a href="mailto:legal@vineyardgroupfellowship.org" className={styles.link}>legal@vineyardgroupfellowship.org</a></li>
              <li><strong>Safety Concerns:</strong> <a href="mailto:safety@vineyardgroupfellowship.org" className={styles.link}>safety@vineyardgroupfellowship.org</a></li>
          ...
          <section className={styles.section}>
            ...
            <ul>
              <li><strong>Mutual respect</strong> for every person's recovery journey</li>
              <li><strong>Confidentiality</strong> that protects everyone's privacy and safety</li>
              <li><strong>Hope</strong> that healing and growth are possible for everyone</li>
