 ...
 */
export const getRelativeTime = (date: string, { includeTime = false } = {}): number | string | RelativeTimeResult => {
  if (!date) {
    return '';
  }
 ...
 */
export const normalizeImageUrl = (value: string | Blob = '') => {
  if (!value) {
    return '';
  }
...
export class ErrorBoundary extends React.Component<ErrorBoundaryProps, ErrorBoundaryState> {
   ...
   * @param {Object} info - An object containing information about the component stack.
   */
